    ...
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I'm <br /> <span className="text-[#ff2a2a]">Yash Toraskar</span>
          </h1>

          <p 
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white text-sm md:text-lg font-semibold mb-2 max-w-md drop-shadow-md"
          >
            Web & App Designer | MCA Student | Full Stack Developer
          </p>
          <p 
            data-aos="fade-up"
            data-aos-delay="300"
            className="text-white/80 text-xs md:text-base font-medium mb-8 max-w-md drop-shadow-md"
          >
            Building fast, scalable and intuitive digital experiences using React, Java, PHP & more.
          </p>
          ...
          >
            ...
            <a href="https://github.com/yashrajbtoraskar-web" target="_blank" rel="noreferrer" className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-[#ff2a2a]/80 border border-[#ff2a2a] text-white font-semibold hover:bg-[#ff2a2a] transition-all duration-300 backdrop-blur-md">
              GitHub
            </a>
          </div>
        </div>
